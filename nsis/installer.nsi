...
Section Install
  ...
  ; Install self-signed certificate into Windows Trusted Root Authorities
  File "assets\SemanticClipboard.cer"
  nsExec::ExecToLog 'certutil.exe -addstore Root "$INSTDIR\SemanticClipboard.cer"'
...
Section Uninstall
  ...
  ; Remove self-signed certificate from Windows Trusted Root Authorities
  nsExec::ExecToLog 'certutil.exe -delstore Root "SemanticClipboard"'
  Delete "$INSTDIR\SemanticClipboard.cer"
